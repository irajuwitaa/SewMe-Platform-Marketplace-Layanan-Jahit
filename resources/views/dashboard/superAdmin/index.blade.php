                                ...
                                <div class="row mb-5">
                                        ...
                                        <div class="card h-lg-100">
                                            <div class="card-body d-flex justify-content-between align-items-start flex-column">
                                                ...
                                                <div class="d-flex flex-column my-7">
                                                    <span class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2">{{ $akunUser }}</span>
                                                    <div class="m-0">
                                                        <span class="fw-semibold fs-6 text-gray-500">Pelanggan</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-6 mb-6">
                                        <div class="card h-lg-100">
                                            <div class="card-body d-flex justify-content-between align-items-start flex-column">
                                                <div class="m-0">
                                                    <i class="ki-duotone ki-delivery-2 fs-2hx text-gray-600">
                                                        <span class="path1"></span>
                                                        <span class="path2"></span>
                                                ...
                                                <div class="d-flex flex-column my-7">
                                                    <span class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2">{{ $akunPenjahit }}</span>
                                                    <div class="m-0">
                                                        <span class="fw-semibold fs-6 text-gray-500">Penjahit</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12 mb-6">
                                        <div class="card h-lg-100 bg-dark" >
                                            <div class="card-body d-flex justify-content-between align-items-start flex-column">
                                                <div class="m-0">
                                                    <i class="ki-duotone ki-bill fs-2hx text-gray-500">
                                                        <span class="path1"></span>
                                                        <span class="path2"></span>
                                                        <span class="path3"></span>
                                                        <span class="path4"></span>
                                                ...
                                                <div class="d-flex flex-column my-7">
                                                    <span class="fw-semibold fs-3x text-white lh-1 ls-n2">{{ $totalPesanan }}</span>
                                                    <div class="m-0">
                                                        <span class="fw-semibold fs-6 text-gray-500">Order Bulan ini</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-xl-8 ps-xl-12">
                                ...
                                <div class="row g-5 g-xl-8">
                                    <div class="col-xl-6 col-lg-6 col-md-6">
                                        <a href="#" class="card hoverable card-xl-stretch mb-xl-8" style="background-color: #272e54;">
                                            <div class="card-body">
                                                ...
                                                <div class="text-white fw-bold fs-2 mb-2 mt-5">Program Pengguna Baru</div>
                                                <div class="fw-semibold text-white">Penawaran spesial untuk pengguna baru</div>
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-xl-6 col-md-6">
                                        <a href="#" class="card hoverable card-xl-stretch mb-xl-8" style="background-color: #272e54;">
                                            <div class="card-body">
                                                ...
                                                <div class="fw-semibold text-white">Rayakan dengan penawaran istimewa</div>
                                            </div>
                                        </a>
                                    </div>
                                </div>
